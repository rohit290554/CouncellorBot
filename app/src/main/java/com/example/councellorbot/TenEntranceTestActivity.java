...
public class TenEntranceTestActivity extends AppCompatActivity implements View.OnClickListener {
    TextView tv_question;

    private TenQuestion question = new TenQuestion();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ten_entrance_test);
    ...
    private void TestOverWithPreviousMarks() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(TenEntranceTestActivity.this);
        alertDialogBuilder
                .setTitle("Test Over")
                ...
                .setPositiveButton("Start Test Again", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(getApplicationContext(), TenEntranceTestActivity.class));
                        finish();
                    }
                })
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (obj.getString("error").equalsIgnoreCase("false")) {
                                Toast.makeText(TenEntranceTestActivity.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
