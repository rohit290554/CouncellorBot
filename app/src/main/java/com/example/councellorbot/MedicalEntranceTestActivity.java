...
public class MedicalEntranceTestActivity extends AppCompatActivity implements View.OnClickListener {
    TextView tv_question;

    private MedicalQuestion question = new MedicalQuestion();
    private static final String API_URL = Config.ROOT_URL+"Api.php?apicall=recordmarks";
    ProgressDialog progressDialog;

    private String answer,user_id,test,status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medical_entrance_test);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (obj.getString("error").equalsIgnoreCase("false")) {
                                Toast.makeText(MedicalEntranceTestActivity.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(MedicalEntranceTestActivity.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
                            }
    ...
    private void TestOver(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MedicalEntranceTestActivity.this);
        alertDialogBuilder
                .setTitle("Test Over")
                ...
                .setPositiveButton("Start Test Again", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(getApplicationContext(), MedicalEntranceTestActivity.class));
                        finish();
                    }
                })
