...
public class EngineeringEntranceTestActivity extends AppCompatActivity implements View.OnClickListener {
    TextView tv_question;

    private EngineeringQuestion question = new EngineeringQuestion();
    ...
    private void TestOverWithPreviousMarks() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EngineeringEntranceTestActivity.this);
        alertDialogBuilder
                .setTitle("Test Over")
                ...
                .setPositiveButton("Start Test Again", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(getApplicationContext(), EngineeringEntranceTestActivity.class));
                        finish();
                    }
                })
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (obj.getString("error").equalsIgnoreCase("false")) {
                                Toast.makeText(EngineeringEntranceTestActivity.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
